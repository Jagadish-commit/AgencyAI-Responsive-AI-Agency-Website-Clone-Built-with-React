...
const OurWork = () => {
    ...
    const workData = [
        {
            ...
            description: 'We turn your ideas into stunning mobile app designs that captivate users and drive engagement.',
            image: assets.work_mobile_app
        },
        {
            title: 'Dashboard Design',
            description: 'We create intuitive and visually appealing dashboards that provide valuable insights and improve decision-making.',
  ...
  return (
    ...
    id='our-work' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      <Title title='Our Latest Work' desc='Check out some of our recent projects and see how we can help your business grow.' />
